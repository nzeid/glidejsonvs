...
C = gcc
C1FlAGS = -std=c11 -Wpedantic -Wall -Wextra -Wpointer-arith -Werror=vla -march=native
C2FLAGS = -c -O2 -I. \
-I./GlideJson/glidejson-1.1.0/include/siphash
COFLAGS = $(C2FLAGS) $(C1FLAGS)
CC = g++
CC1FLAGS = -std=c++11 -Wpedantic -Wall -Wextra -Wpointer-arith -Werror=vla -march=native
CC2FLAGS = -c -O2 -I. \
-I./GlideJson/glidejson-1.1.0/include/siphash \
-I./GlideJson/glidejson-1.1.0/include/glidejson \
...
GLIDE_JSON_VS_SOURCES_CPP = GlideJsonVs.cpp GlideJson/glidejson-1.1.0/src/glidejson/GlideJson.cpp $(wildcard jsoncpp/jsoncpp-1.9.4/src/lib_json/*.cpp)
GLIDE_JSON_VS_SOURCES_C = $(wildcard GlideJson/glidejson-1.1.0/src/siphash/*.c) cjson/cJSON-1.7.14/cJSON.c
